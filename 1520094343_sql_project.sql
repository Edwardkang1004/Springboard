...
SELECT CONCAT( m.firstname,  ' ', m.surname ) AS member, f.name AS facility,  (CASE WHEN m.memid = 0 THEN f.guestcost * b.slots ELSE f.membercost * b.slots END) AS cost
FROM Members As m
INNER JOIN Bookings as b ON ( m.memid = b.memid ) 
INNER JOIN Facilities as f ON ( b.facid = f.facid ) 
WHERE b.starttime = '2012-09-14' 
AND f.guestcost * b.slots > 30
OR f.membercost * b.slots > 30
ORDER BY cost DESC
...
SELECT f.name AS facility,  SUM(CASE WHEN b.memid = 0 THEN f.guestcost * b.slots ELSE f.membercost * b.slots END) AS revenue
